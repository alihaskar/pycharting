...
class TestOHLCDetection:
    ...
    @patch('charting.charting.detect_ohlc_columns')
...
class TestIndicatorClassification:
    ...
    @patch('charting.charting.classify_indicators')
    @patch('charting.charting.detect_indicator_columns')
    @patch('charting.charting.detect_ohlc_columns')
...
class TestLoadOrchestration:
    ...
    @patch('charting.charting.transform_dataframe_to_csv')
    @patch('charting.charting.detect_ohlc_columns')
    ...
    @patch('charting.charting.ServerManager')
    @patch('charting.charting.transform_dataframe_to_csv')
    @patch('charting.charting.detect_ohlc_columns')
    ...
    @patch('charting.charting.launch_browser')
    @patch('charting.charting.ServerManager')
    @patch('charting.charting.transform_dataframe_to_csv')
    @patch('charting.charting.detect_ohlc_columns')
