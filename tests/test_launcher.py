...
class TestLaunchChart:
    ...
    @patch('charting.launcher.Charting')
    def test_launch_chart_creates_charting_instance(self, mock_charting_class):
        ...
        from charting.launcher import launch_chart, generate_sample_data
...
class TestMainFunction:
    ...
    @patch('charting.launcher.launch_chart')
    @patch('charting.launcher.generate_sample_data')
